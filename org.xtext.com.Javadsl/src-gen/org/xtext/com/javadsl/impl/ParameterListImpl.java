 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.com.javadsl.impl.ParameterListImpl#getStatement_block <em>Statement block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MethodDeclarationImpl implements ParameterList
{
  /**
  ...
  {
    return JavadslPackage.Literals.PARAMETER_LIST;
  }
  ...
  public NotificationChain basicSetStatement_block(StatementBlock newStatement_block, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK, oldStatement_block, newStatement_block);
  ...
  public void setStatement_block(StatementBlock newStatement_block)
  {
    if (newStatement_block != statement_block)
    {
      ...
      if (statement_block != null)
        msgs = ((InternalEObject)statement_block).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK, null, msgs);
      if (newStatement_block != null)
        msgs = ((InternalEObject)newStatement_block).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK, null, msgs);
      msgs = basicSetStatement_block(newStatement_block, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK, newStatement_block, newStatement_block));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == ConstructorDeclaration.class)
    {
      ...
      {
        case JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK: return JavadslPackage.CONSTRUCTOR_DECLARATION__STATEMENT_BLOCK;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == ConstructorDeclaration.class)
    {
      ...
      {
        case JavadslPackage.CONSTRUCTOR_DECLARATION__STATEMENT_BLOCK: return JavadslPackage.PARAMETER_LIST__STATEMENT_BLOCK;
        default: return -1;
      }
    }
